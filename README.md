To configure the database connection, your Apache config file has to be modified (it should be at wamp64\bin\apache\apache2.4.33\conf\extra\httpd-vhosts.conf):
